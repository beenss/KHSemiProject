    ...
    <div class="wrapper">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col">
            <!--등록된 회원정보-->
            <div class="row">주문상품명</div>
            <div class="row">결제금액</div>
            <div class="row">회원명</div>
            <div class="row">회원연락처</div>
            <div class="row">회원주소</div>
          ...
          <div class="col">
            <!--결제정보 -->
            <div class="row">결제자이름</div>
            <div class="row">결제자연락처</div>
            <div class="row">결제자주소</div>
            <div class="row">결제자이메일</div>
          </div>
        </div>
        <div class="row">
          <div class="col">
            <!-- 수취인정보 -->
            <div class="row">수취인이름</div>
            <div class="row">수취인연락처</div>
            <div class="row">주소api</div>
            <div class="row">수취인주소</div>
            <div class="row">주문메시지</div>
            <div class="row">배송메시지</div>
          </div>

          <div class="col">
            <!--결제api -->
            <div class="row">결제API</div>
