				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav me-auto mb-2 mb-lg-0">
						<li class="nav-item"><a class="nav-link"
							style="color: rgb(255, 255, 255);" href="#">제품 보기</a></li>
						<li class="nav-item"><a class="nav-link"
							style="color: rgb(255, 255, 255);" href="#">고객센터</a></li>
						<li class="nav-item"><a class="nav-link"
							style="color: rgb(255, 255, 255);" href="#">회원 가입</a></li>
						<li class="nav-item"><a class="nav-link"
							style="color: rgb(255, 255, 255);" href="#">리뷰</a></li>
						<li class="nav-item"><a class="nav-link"
							style="color: rgb(255, 255, 255);" href="#">로그인</a></li>
						<li class="nav-item"><a class="nav-link"
							style="color: rgb(218, 255, 193); font-weight: bold;" href="#">구독하기</a>
